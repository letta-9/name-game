...
GRAY_RECT = pygame.image.load("images/GRAY Rect.png")
INPUT_BG = pygame.image.load("images/input.png")
TWITTER = pygame.image.load("images/twitter.png")
HEART = pygame.transform.scale(pygame.image.load("images/heart.png"), (100, 100))
BASEBALL_RULES = pygame.transform.scale(pygame.image.load("images/baseball_rules.png"), (400, 350))
FOOTBALL_RULES = pygame.transform.scale(pygame.image.load("images/football_rules.png"), (400, 350))
BASKETBALL_RULES = pygame.transform.scale(pygame.image.load("images/basketball_rules.png"), (400, 350))
HOCKEY_RULES = pygame.transform.scale(pygame.image.load("images/hockey_rules.png"), (400, 350))
...
def disp_high_scores(cat):
    LEADERBOARD = pd.read_csv(f"csv/{cat}_highscores.csv")
...
def baseball():
    ...
    USED_NAMES = []
    DISPLAY = ""
    MLB_LIST = pd.read_csv('csv/mlb_list.csv')
    TURNS = 0
    DOUBLE_STREAK = 0
                    ...
                    if event.type == pygame.KEYDOWN:
                        if event.key == pygame.K_BACKSPACE:
                            ...
                            if SAVES == 0:
                                ...
                                HIGHSCORE_DF.to_csv('csv/mlb_highscores.csv', mode='a', index=False, header=False)
                                INITIALS = ""
                            else:
                                INITIALS = ""
...
def football():
    ...
    USED_NAMES = []
    DISPLAY = ""
    NFL_LIST = pd.read_csv('csv/nfl_list.csv')
    TURNS = 0
    DOUBLE_STREAK = 0
                    ...
                    if event.type == pygame.KEYDOWN:
                        if event.key == pygame.K_BACKSPACE:
                            ...
                            if SAVES == 0:
                                ...
                                HIGHSCORE_DF = pd.DataFrame(SCORE_INIT)
                                HIGHSCORE_DF = HIGHSCORE_DF.sort_values(by=['score'])
                                HIGHSCORE_DF.to_csv('csv/nfl_highscores.csv', mode='a', index=False, header=False)
                                INITIALS = ""
                            else:
                                INITIALS = ""
...
def basketball_rules():
    while True:
        ...
        RULES_BODY = BASKETBALL_RULES.get_rect(center=(640,350))
        SCREEN.blit(BASKETBALL_RULES, RULES_BODY)
...
def basketball():
    ...
    USED_NAMES = []
    DISPLAY = ""
    NBA_LIST = pd.read_csv('csv/nba_list.csv')
    TURNS = 0
    DOUBLE_STREAK = 0
                    ...
                    if event.type == pygame.KEYDOWN:
                        if event.key == pygame.K_BACKSPACE:
                            ...
                            if SAVES == 0:
                                ...
                                HIGHSCORE_DF = pd.DataFrame(SCORE_INIT)
                                HIGHSCORE_DF = HIGHSCORE_DF.sort_values(by=['score'])
                                HIGHSCORE_DF.to_csv('csv/nba_highscores.csv', mode='a', index=False, header=False)
                                INITIALS = ""
                            else:
                                INITIALS = ""
...
def hockey_rules():
    while True:
        ...
        RULES_BODY = HOCKEY_RULES.get_rect(center=(640,350))
        SCREEN.blit(HOCKEY_RULES, RULES_BODY)
...
def hockey():
    ...
    USED_NAMES = []
    DISPLAY = ""
    NHL_LIST = pd.read_csv('csv/nhl_list.csv')
    TURNS = 0
    DOUBLE_STREAK = 0
                    ...
                    if event.type == pygame.KEYDOWN:
                        if event.key == pygame.K_BACKSPACE:
                            ...
                            if SAVES == 0:
                                ...
                                HIGHSCORE_DF = pd.DataFrame(SCORE_INIT)
                                HIGHSCORE_DF = HIGHSCORE_DF.sort_values(by=['score'])
                                HIGHSCORE_DF.to_csv('csv/nhl_highscores.csv', mode='a', index=False, header=False)
                                INITIALS = ""
                            else:
                                INITIALS = ""
